...
/**
 * The TransferTableModel class represents the table model for transfers in the GUI.
 */
public class TransferTableModel extends MainTableModel {
  ...
  public Object getValueAt(int row, int column) {
    ...
    return switch (column) {
      ...
      case FROM_AMOUNT -> Format.amount(transfer.getFromAmount(),
      transfer.getFromAccount().getCurrency());
      case TO_AMOUNT -> Format.amount(transfer.getToAmount(),
